...
-export_records(['WLAN-Identifier',
                 'Access-Network-Info',
...
avp_header('AAA-Failure-Indication') ->
    {1518, 128, 10415};
avp_header('AAR-Flags') -> {1539, 128, 10415};
...
avp_header('ERP-Authorization') -> {1541, 128, 10415};
...
avp_header('MIP6-Feature-Vector') ->
    {124, 64, undefined};
avp_header('Maximum-Wait-Time') -> {1537, 128, 10415};
