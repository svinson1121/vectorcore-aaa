...
msg_header('AMR') -> {260, 192, 1};
msg_header('AMA') -> {260, 64, 1};
msg_header('HAR') -> {262, 192, 1};
msg_header('HAA') -> {262, 64, 1};
...
avp_arity('AMR') ->
    [{'Session-Id', 1},
     ...
     {'Origin-State-Id', {0, 1}},
     {'MIP-Mobile-Node-Address', {0, 1}},
     {'MIP-Home-Agent-Address', {0, 1}},
     {'MIP-Feature-Vector', {0, 1}},
     {'MIP-Originating-Foreign-AAA', {0, 1}},
     {'Authorization-Lifetime', {0, 1}},
     {'Auth-Session-State', {0, 1}},
     {'MIP-FA-Challenge', {0, 1}},
     {'MIP-Candidate-Home-Agent-Host', {0, 1}},
     {'MIP-Home-Agent-Host', {0, 1}},
     {'MIP-HA-to-FA-SPI', {0, 1}},
     {'Proxy-Info', {0, '*'}},
     {'Route-Record', {0, '*'}},
     {'AVP', {0, '*'}}];
avp_arity('AMA') ->
    [{'Session-Id', 1},
     ...
     {'MIP-Feature-Vector', {0, 1}},
     {'MIP-Reg-Reply', {0, 1}},
     {'MIP-MN-to-FA-MSA', {0, 1}},
     {'MIP-MN-to-HA-MSA', {0, 1}},
     {'MIP-FA-to-MN-MSA', {0, 1}},
     {'MIP-FA-to-HA-MSA', {0, 1}},
     {'MIP-HA-to-MN-MSA', {0, 1}},
     {'MIP-MSA-Lifetime', {0, 1}},
     {'MIP-Home-Agent-Address', {0, 1}},
     {'MIP-Mobile-Node-Address', {0, 1}},
     {'MIP-Filter-Rule', {0, '*'}}];
avp_arity('HAR') ->
    [{'Session-Id', 1},
     ...
     {'User-Name', 1},
     {'Destination-Realm', 1},
     {'MIP-Feature-Vector', 1},
     {'Destination-Host', {0, 1}},
     {'MIP-MN-to-HA-MSA', {0, 1}},
     {'MIP-MN-to-FA-MSA', {0, 1}},
     {'MIP-HA-to-MN-MSA', {0, 1}},
     {'MIP-HA-to-FA-MSA', {0, 1}},
     {'MIP-MSA-Lifetime', {0, 1}},
     {'MIP-Originating-Foreign-AAA', {0, 1}},
     {'MIP-Mobile-Node-Address', {0, 1}},
     {'MIP-Home-Agent-Address', {0, 1}},
...
avp_arity('HAA') ->
    [{'Session-Id', 1},
     ...
     {'MIP-Home-Agent-Address', {0, 1}},
     {'MIP-Mobile-Node-Address', {0, 1}},
     {'MIP-FA-to-HA-SPI', {0, 1}},
     {'MIP-FA-to-MN-SPI', {0, 1}},
     {'Origin-State-Id', {0, 1}},
     {'Proxy-Info', {0, '*'}},
     {'AVP', {0, '*'}}];
