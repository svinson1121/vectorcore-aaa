...
msg_name(320, true) -> 'DSR';
msg_name(320, false) -> 'DSA';
msg_name(321, true) -> 'PUR';
msg_name(321, false) -> 'PUA';
msg_name(322, true) -> 'RSR';
msg_name(322, false) -> 'RSA';
msg_name(323, true) -> 'NOR';
msg_name(323, false) -> 'NOA';
msg_name(324, true) -> 'ECR';
msg_name(324, false) -> 'ECA';
msg_name(316, true) -> 'ULR';
msg_name(316, false) -> 'ULA';
msg_name(317, true) -> 'CLR';
msg_name(317, false) -> 'CLA';
msg_name(318, true) -> 'AIR';
msg_name(318, false) -> 'AIA';
msg_name(319, true) -> 'IDR';
msg_name(319, false) -> 'IDA';
msg_name(_, _) -> ''.

msg_header('ULR') -> {316, 192, 16777251};
msg_header('ULA') -> {316, 64, 16777251};
msg_header('AIR') -> {318, 192, 16777251};
msg_header('AIA') -> {318, 64, 16777251};
msg_header('CLR') -> {317, 192, 16777251};
msg_header('CLA') -> {317, 64, 16777251};
msg_header('IDR') -> {319, 192, 16777251};
msg_header('IDA') -> {319, 64, 16777251};
msg_header('DSR') -> {320, 192, 16777251};
msg_header('DSA') -> {320, 64, 16777251};
msg_header('PUR') -> {321, 192, 16777251};
msg_header('PUA') -> {321, 64, 16777251};
msg_header('RSR') -> {322, 192, 16777251};
msg_header('RSA') -> {322, 64, 16777251};
msg_header('NOR') -> {323, 192, 16777251};
msg_header('NOA') -> {323, 64, 16777251};
msg_header('ECR') -> {324, 192, 16777251};
msg_header('ECA') -> {324, 64, 16777251};
...
avp_arity('ULR') ->
    [{'Session-Id', 1},
     ...
     {'UE-SRVCC-Capability', {0, 1}},
     {'SGSN-Number', {0, 1}},
     {'Homogeneous-Support-of-IMS-Voice-Over-PS-Sessions',
      {0, 1}},
     {'GMLC-Address', {0, 1}},
     {'Equivalent-PLMN-List', {0, 1}},
     {'MME-Number-for-MT-SMS', {0, 1}},
     {'SMS-Register-Request', {0, 1}},
...
avp_arity('AIR') ->
    [{'Session-Id', 1},
     ...
     {'Vendor-Specific-Application-Id', {0, 1}},
     {'Destination-Host', {0, 1}},
     {'Requested-EUTRAN-Authentication-Info', {0, 1}},
     {'Requested-UTRAN-GERAN-Authentication-Info', {0, 1}},
     {'Supported-Features', {0, '*'}},
     {'Proxy-Info', {0, '*'}},
     {'Route-Record', {0, '*'}},
     {'AVP', {0, '*'}}];
...
avp_arity('IDA') ->
    [{'Session-Id', 1},
     ...
     {'Result-Code', {0, 1}},
     {'Experimental-Result', {0, 1}},
     {'IMS-Voice-Over-PS-Sessions-Supported', {0, 1}},
     {'Last-UE-Activity-Time', {0, 1}},
     {'RAT-Type', {0, 1}},
     {'IDA-Flags', {0, 1}},
     {'EPS-User-State', {0, 1}},
...
avp_arity('ULR', 'Session-Id') -> 1;
avp_arity('ULR', 'Auth-Session-State') -> 1;
avp_arity('ULR', 'Origin-Host') -> 1;
avp_arity('ULR', 'Origin-Realm') -> 1;
avp_arity('ULR', 'Destination-Realm') -> 1;
avp_arity('ULR', 'User-Name') -> 1;
avp_arity('ULR', 'RAT-Type') -> 1;
avp_arity('ULR', 'ULR-Flags') -> 1;
avp_arity('ULR', 'Visited-PLMN-Id') -> 1;
avp_arity('ULR', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('ULR', 'Destination-Host') -> {0, 1};
avp_arity('ULR', 'Terminal-Information') -> {0, 1};
avp_arity('ULR', 'UE-SRVCC-Capability') -> {0, 1};
avp_arity('ULR', 'SGSN-Number') -> {0, 1};
avp_arity('ULR',
          'Homogeneous-Support-of-IMS-Voice-Over-PS-Sessions') ->
    {0, 1};
avp_arity('ULR', 'GMLC-Address') -> {0, 1};
avp_arity('ULR', 'Equivalent-PLMN-List') -> {0, 1};
avp_arity('ULR', 'MME-Number-for-MT-SMS') -> {0, 1};
avp_arity('ULR', 'SMS-Register-Request') -> {0, 1};
avp_arity('ULR', 'Supported-Features') -> {0, '*'};
avp_arity('ULR', 'Active-APN') -> {0, '*'};
avp_arity('ULR', 'Proxy-Info') -> {0, '*'};
avp_arity('ULR', 'Route-Record') -> {0, '*'};
avp_arity('ULR', 'AVP') -> {0, '*'};
avp_arity('ULA', 'Session-Id') -> 1;
avp_arity('ULA', 'Auth-Session-State') -> 1;
avp_arity('ULA', 'Origin-Host') -> 1;
avp_arity('ULA', 'Origin-Realm') -> 1;
avp_arity('ULA', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('ULA', 'Result-Code') -> {0, 1};
avp_arity('ULA', 'Experimental-Result') -> {0, 1};
avp_arity('ULA', 'Error-Diagnostic') -> {0, 1};
avp_arity('ULA', 'ULA-Flags') -> {0, 1};
avp_arity('ULA', 'Subscription-Data') -> {0, 1};
avp_arity('ULA', 'Supported-Features') -> {0, '*'};
avp_arity('ULA', 'AVP') -> {0, '*'};
avp_arity('ULA', 'Failed-AVP') -> {0, '*'};
avp_arity('ULA', 'Proxy-Info') -> {0, '*'};
avp_arity('ULA', 'Route-Record') -> {0, '*'};
avp_arity('AIR', 'Session-Id') -> 1;
avp_arity('AIR', 'Auth-Session-State') -> 1;
avp_arity('AIR', 'Origin-Host') -> 1;
avp_arity('AIR', 'Origin-Realm') -> 1;
avp_arity('AIR', 'Destination-Realm') -> 1;
avp_arity('AIR', 'User-Name') -> 1;
avp_arity('AIR', 'Visited-PLMN-Id') -> 1;
avp_arity('AIR', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('AIR', 'Destination-Host') -> {0, 1};
avp_arity('AIR',
          'Requested-EUTRAN-Authentication-Info') ->
    {0, 1};
avp_arity('AIR',
          'Requested-UTRAN-GERAN-Authentication-Info') ->
    {0, 1};
avp_arity('AIR', 'Supported-Features') -> {0, '*'};
avp_arity('AIR', 'Proxy-Info') -> {0, '*'};
avp_arity('AIR', 'Route-Record') -> {0, '*'};
avp_arity('AIR', 'AVP') -> {0, '*'};
avp_arity('AIA', 'Session-Id') -> 1;
avp_arity('AIA', 'Auth-Session-State') -> 1;
avp_arity('AIA', 'Origin-Host') -> 1;
avp_arity('AIA', 'Origin-Realm') -> 1;
avp_arity('AIA', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('AIA', 'Result-Code') -> {0, 1};
avp_arity('AIA', 'Experimental-Result') -> {0, 1};
avp_arity('AIA', 'Error-Diagnostic') -> {0, 1};
avp_arity('AIA', 'Authentication-Info') -> {0, 1};
avp_arity('AIA', 'Supported-Features') -> {0, '*'};
avp_arity('AIA', 'AVP') -> {0, '*'};
avp_arity('AIA', 'Failed-AVP') -> {0, '*'};
avp_arity('AIA', 'Proxy-Info') -> {0, '*'};
avp_arity('AIA', 'Route-Record') -> {0, '*'};
avp_arity('CLR', 'Session-Id') -> 1;
avp_arity('CLR', 'Auth-Session-State') -> 1;
avp_arity('CLR', 'Origin-Host') -> 1;
avp_arity('CLR', 'Origin-Realm') -> 1;
avp_arity('CLR', 'Destination-Host') -> 1;
avp_arity('CLR', 'Destination-Realm') -> 1;
avp_arity('CLR', 'User-Name') -> 1;
avp_arity('CLR', 'Cancellation-Type') -> 1;
avp_arity('CLR', 'Supported-Features') -> {0, '*'};
avp_arity('CLR', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('CLR', 'CLR-Flags') -> {0, 1};
avp_arity('CLR', 'AVP') -> {0, '*'};
avp_arity('CLR', 'Proxy-Info') -> {0, '*'};
avp_arity('CLR', 'Route-Record') -> {0, '*'};
avp_arity('CLA', 'Session-Id') -> 1;
avp_arity('CLA', 'Auth-Session-State') -> 1;
avp_arity('CLA', 'Origin-Host') -> 1;
avp_arity('CLA', 'Origin-Realm') -> 1;
avp_arity('CLA', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('CLA', 'Supported-Features') -> {0, '*'};
avp_arity('CLA', 'Result-Code') -> {0, 1};
avp_arity('CLA', 'Experimental-Result') -> {0, 1};
avp_arity('CLA', 'AVP') -> {0, '*'};
avp_arity('CLA', 'Failed-AVP') -> {0, '*'};
avp_arity('CLA', 'Proxy-Info') -> {0, '*'};
avp_arity('CLA', 'Route-Record') -> {0, '*'};
avp_arity('IDR', 'Session-Id') -> 1;
avp_arity('IDR', 'Auth-Session-State') -> 1;
avp_arity('IDR', 'Origin-Host') -> 1;
avp_arity('IDR', 'Origin-Realm') -> 1;
avp_arity('IDR', 'Destination-Host') -> 1;
avp_arity('IDR', 'Destination-Realm') -> 1;
avp_arity('IDR', 'User-Name') -> 1;
avp_arity('IDR', 'Subscription-Data') -> 1;
avp_arity('IDR', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('IDR', 'Supported-Features') -> {0, '*'};
avp_arity('IDR', 'IDR-Flags') -> {0, 1};
avp_arity('IDR', 'AVP') -> {0, '*'};
avp_arity('IDR', 'Proxy-Info') -> {0, '*'};
avp_arity('IDR', 'Route-Record') -> {0, '*'};
avp_arity('IDA', 'Session-Id') -> 1;
avp_arity('IDA', 'Auth-Session-State') -> 1;
avp_arity('IDA', 'Origin-Host') -> 1;
avp_arity('IDA', 'Origin-Realm') -> 1;
avp_arity('IDA', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('IDA', 'Supported-Features') -> {0, '*'};
avp_arity('IDA', 'Result-Code') -> {0, 1};
avp_arity('IDA', 'Experimental-Result') -> {0, 1};
avp_arity('IDA',
          'IMS-Voice-Over-PS-Sessions-Supported') ->
    {0, 1};
avp_arity('IDA', 'Last-UE-Activity-Time') -> {0, 1};
avp_arity('IDA', 'RAT-Type') -> {0, 1};
avp_arity('IDA', 'IDA-Flags') -> {0, 1};
avp_arity('IDA', 'EPS-User-State') -> {0, 1};
avp_arity('IDA', 'EPS-Location-Information') -> {0, 1};
avp_arity('IDA', 'Local-Time-Zone') -> {0, 1};
avp_arity('IDA', 'AVP') -> {0, '*'};
avp_arity('IDA', 'Failed-AVP') -> {0, '*'};
avp_arity('IDA', 'Proxy-Info') -> {0, '*'};
avp_arity('IDA', 'Route-Record') -> {0, '*'};
avp_arity('DSR', 'Session-Id') -> 1;
avp_arity('DSR', 'Auth-Session-State') -> 1;
avp_arity('DSR', 'Origin-Host') -> 1;
avp_arity('DSR', 'Origin-Realm') -> 1;
avp_arity('DSR', 'Destination-Host') -> 1;
avp_arity('DSR', 'Destination-Realm') -> 1;
avp_arity('DSR', 'User-Name') -> 1;
avp_arity('DSR', 'DSR-Flags') -> 1;
avp_arity('DSR', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('DSR', 'Supported-Features') -> {0, '*'};
avp_arity('DSR', 'Context-Identifier') -> {0, '*'};
avp_arity('DSR', 'Trace-Reference') -> {0, 1};
avp_arity('DSR', 'TS-Code') -> {0, '*'};
avp_arity('DSR', 'SS-Code') -> {0, '*'};
avp_arity('DSR', 'AVP') -> {0, '*'};
avp_arity('DSR', 'Proxy-Info') -> {0, '*'};
avp_arity('DSR', 'Route-Record') -> {0, '*'};
avp_arity('DSA', 'Session-Id') -> 1;
avp_arity('DSA', 'Auth-Session-State') -> 1;
avp_arity('DSA', 'Origin-Host') -> 1;
avp_arity('DSA', 'Origin-Realm') -> 1;
avp_arity('DSA', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('DSA', 'Supported-Features') -> {0, '*'};
avp_arity('DSA', 'Result-Code') -> {0, 1};
avp_arity('DSA', 'Experimental-Result') -> {0, 1};
avp_arity('DSA', 'DSA-Flags') -> {0, 1};
avp_arity('DSA', 'AVP') -> {0, '*'};
avp_arity('DSA', 'Failed-AVP') -> {0, '*'};
avp_arity('DSA', 'Proxy-Info') -> {0, '*'};
avp_arity('DSA', 'Route-Record') -> {0, '*'};
avp_arity('PUR', 'Session-Id') -> 1;
avp_arity('PUR', 'Auth-Session-State') -> 1;
avp_arity('PUR', 'Origin-Host') -> 1;
avp_arity('PUR', 'Origin-Realm') -> 1;
avp_arity('PUR', 'Destination-Realm') -> 1;
avp_arity('PUR', 'User-Name') -> 1;
avp_arity('PUR', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('PUR', 'Destination-Host') -> {0, 1};
avp_arity('PUR', 'PUR-Flags') -> {0, 1};
avp_arity('PUR', 'Supported-Features') -> {0, '*'};
avp_arity('PUR', 'AVP') -> {0, '*'};
avp_arity('PUR', 'Proxy-Info') -> {0, '*'};
avp_arity('PUR', 'Route-Record') -> {0, '*'};
avp_arity('PUA', 'Session-Id') -> 1;
avp_arity('PUA', 'Auth-Session-State') -> 1;
avp_arity('PUA', 'Origin-Host') -> 1;
avp_arity('PUA', 'Origin-Realm') -> 1;
avp_arity('PUA', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('PUA', 'Supported-Features') -> {0, '*'};
avp_arity('PUA', 'Result-Code') -> {0, 1};
avp_arity('PUA', 'Experimental-Result') -> {0, 1};
avp_arity('PUA', 'PUA-Flags') -> {0, 1};
avp_arity('PUA', 'AVP') -> {0, '*'};
avp_arity('PUA', 'Failed-AVP') -> {0, '*'};
avp_arity('PUA', 'Proxy-Info') -> {0, '*'};
avp_arity('PUA', 'Route-Record') -> {0, '*'};
avp_arity('RSR', 'Session-Id') -> 1;
avp_arity('RSR', 'Auth-Session-State') -> 1;
avp_arity('RSR', 'Origin-Host') -> 1;
avp_arity('RSR', 'Origin-Realm') -> 1;
avp_arity('RSR', 'Destination-Host') -> 1;
avp_arity('RSR', 'Destination-Realm') -> 1;
avp_arity('RSR', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('RSR', 'Supported-Features') -> {0, '*'};
avp_arity('RSR', 'User-Id') -> {0, '*'};
avp_arity('RSR', 'AVP') -> {0, '*'};
avp_arity('RSR', 'Proxy-Info') -> {0, '*'};
avp_arity('RSR', 'Route-Record') -> {0, '*'};
avp_arity('RSA', 'Session-Id') -> 1;
avp_arity('RSA', 'Auth-Session-State') -> 1;
avp_arity('RSA', 'Origin-Host') -> 1;
avp_arity('RSA', 'Origin-Realm') -> 1;
avp_arity('RSA', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('RSA', 'Supported-Features') -> {0, '*'};
avp_arity('RSA', 'Result-Code') -> {0, 1};
avp_arity('RSA', 'Experimental-Result') -> {0, 1};
avp_arity('RSA', 'AVP') -> {0, '*'};
avp_arity('RSA', 'Failed-AVP') -> {0, '*'};
avp_arity('RSA', 'Proxy-Info') -> {0, '*'};
avp_arity('RSA', 'Route-Record') -> {0, '*'};
avp_arity('NOR', 'Session-Id') -> 1;
avp_arity('NOR', 'Auth-Session-State') -> 1;
avp_arity('NOR', 'Origin-Host') -> 1;
avp_arity('NOR', 'Origin-Realm') -> 1;
avp_arity('NOR', 'Destination-Realm') -> 1;
avp_arity('NOR', 'User-Name') -> 1;
avp_arity('NOR', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('NOR', 'Destination-Host') -> {0, 1};
avp_arity('NOR', 'Supported-Features') -> {0, '*'};
avp_arity('NOR', 'Terminal-Information') -> {0, 1};
avp_arity('NOR', 'MIP6-Agent-Info') -> {0, 1};
avp_arity('NOR', 'Visited-Network-Identifier') ->
    {0, 1};
avp_arity('NOR', 'Context-Identifier') -> {0, 1};
avp_arity('NOR', 'Service-Selection') -> {0, 1};
avp_arity('NOR', 'Alert-Reason') -> {0, 1};
avp_arity('NOR', 'UE-SRVCC-Capability') -> {0, 1};
avp_arity('NOR', 'NOR-Flags') -> {0, 1};
avp_arity('NOR',
          'Homogeneous-Support-of-IMS-Voice-Over-PS-Sessions') ->
    {0, 1};
avp_arity('NOR', 'AVP') -> {0, '*'};
avp_arity('NOR', 'Proxy-Info') -> {0, '*'};
avp_arity('NOR', 'Route-Record') -> {0, '*'};
avp_arity('NOA', 'Session-Id') -> 1;
avp_arity('NOA', 'Auth-Session-State') -> 1;
avp_arity('NOA', 'Origin-Host') -> 1;
avp_arity('NOA', 'Origin-Realm') -> 1;
avp_arity('NOA', 'Vendor-Specific-Application-Id') ->
    {0, 1};
avp_arity('NOA', 'Result-Code') -> {0, 1};
avp_arity('NOA', 'Experimental-Result') -> {0, 1};
avp_arity('NOA', 'Supported-Features') -> {0, '*'};
avp_arity('NOA', 'AVP') -> {0, '*'};
avp_arity('NOA', 'Failed-AVP') -> {0, '*'};
avp_arity('NOA', 'Proxy-Info') -> {0, '*'};
avp_arity('NOA', 'Route-Record') -> {0, '*'};
...
avp_header('Service-Area-Identity') ->
    {1607, 128, 10415};
avp_header('Service-Type') -> {1483, 192, 10415};
...
avp_header('UE-Usage-Type') -> {1680, 128, 10415};
