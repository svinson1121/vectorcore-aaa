...
-module(diameter_3gpp_ts29_273_sta).
...
name() -> diameter_3gpp_ts29_273_sta.
...
msg_header('DER') -> {268, 192, 16777250};
msg_header('DEA') -> {268, 64, 16777250};
msg_header('AAR') -> {265, 192, 16777250};
msg_header('AAA') -> {265, 64, 16777250};
msg_header('STR') -> {275, 192, 16777250};
msg_header('STA') -> {275, 64, 16777250};
msg_header('RAR') -> {258, 192, 16777250};
msg_header('RAA') -> {258, 64, 16777250};
msg_header('ASR') -> {274, 192, 16777250};
msg_header('ASA') -> {274, 64, 16777250};
