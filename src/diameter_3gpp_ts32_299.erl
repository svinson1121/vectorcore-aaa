...
-export_records(['diameter_3gpp_charging_Access-Network-Info-Change',
                 ...
                 'diameter_3gpp_charging_Charging-Information',
                 'diameter_3gpp_charging_Supported-Features',
                 'diameter_3gpp_charging_Supported-Applications',
                 'diameter_3gpp_charging_SIP-Auth-Data-Item',
                 'diameter_3gpp_charging_Deregistration-Reason',
                 'diameter_3gpp_charging_SIP-Digest-Authenticate']).
...
avp_header('RAN-End-Time') -> {1301, 128, 10415};
avp_header('RAN-Secondary-RAT-Usage-Report') ->
    {1302, 128, 10415};
avp_header('RAN-Start-Time') -> {1303, 128, 10415};
