...
-hrl_name('diameter_3gpp_ts29_273_swm.hrl').
...
%%% -------------------------------------------------------
%%% Grouped AVP records from diameter_rfc5777:
%%% -------------------------------------------------------
...
%%% -------------------------------------------------------
%%% ENUM Macros from diameter_rfc5777:
%%% -------------------------------------------------------

-ifndef('PROTOCOL_PROTOCOL_TODO_CHECK_RFC2780').
-define('PROTOCOL_PROTOCOL_TODO_CHECK_RFC2780', 0).
-endif.
-ifndef('DIRECTION_DIRECTION_IN').
-define('DIRECTION_DIRECTION_IN', 0).
-endif.
-ifndef('DIRECTION_DIRECTION_OUT').
-define('DIRECTION_DIRECTION_OUT', 1).
-endif.
-ifndef('DIRECTION_DIRECTION_BOTH').
-define('DIRECTION_DIRECTION_BOTH', 2).
-endif.
-ifndef('NEGATED_NEGATED_FALSE').
-define('NEGATED_NEGATED_FALSE', 0).
-endif.
-ifndef('NEGATED_NEGATED_TRUE').
-define('NEGATED_NEGATED_TRUE', 1).
-endif.
-ifndef('USE-ASSIGNED-ADDRESS_USE_ASSIGNED_ADDRESS_FALSE').
-define('USE-ASSIGNED-ADDRESS_USE_ASSIGNED_ADDRESS_FALSE', 0).
-endif.
-ifndef('USE-ASSIGNED-ADDRESS_USE_ASSIGNED_ADDRESS_TRUE').
-define('USE-ASSIGNED-ADDRESS_USE_ASSIGNED_ADDRESS_TRUE', 1).
-endif.
-ifndef('DIFFSERV-CODE-POINT_DIFFSERV_CODE_POINT_TODO_CHECK_RFC2474').
-define('DIFFSERV-CODE-POINT_DIFFSERV_CODE_POINT_TODO_CHECK_RFC2474', 0).
-endif.
-ifndef('FRAGMENTATION-FLAG_FRAGMENTATION_FLAG_DF').
-define('FRAGMENTATION-FLAG_FRAGMENTATION_FLAG_DF', 0).
-endif.
-ifndef('FRAGMENTATION-FLAG_FRAGMENTATION_FLAG_MF').
-define('FRAGMENTATION-FLAG_FRAGMENTATION_FLAG_MF', 1).
-endif.
-ifndef('IP-OPTION-TYPE_IP_OPTION_TYPE_TODO_CHECK_RFC2780').
-define('IP-OPTION-TYPE_IP_OPTION_TYPE_TODO_CHECK_RFC2780', 0).
-endif.
-ifndef('TCP-OPTION-TYPE_TCP_OPTION_TYPE_TODO_CHECK_RFC2780').
-define('TCP-OPTION-TYPE_TCP_OPTION_TYPE_TODO_CHECK_RFC2780', 0).
-endif.
-ifndef('ICMP-TYPE-NUMBER_ICMP_TYPE_NUMBER_TODO_CHECK_RFC2780').
-define('ICMP-TYPE-NUMBER_ICMP_TYPE_NUMBER_TODO_CHECK_RFC2780', 0).
-endif.
-ifndef('ICMP-CODE_ICMP_CODE_TODO_CHECK_RFC2780').
-define('ICMP-CODE_ICMP_CODE_TODO_CHECK_RFC2780', 0).
-endif.
-ifndef('TIMEZONE-FLAG_TIMEZOME_FLAG_UTC').
-define('TIMEZONE-FLAG_TIMEZOME_FLAG_UTC', 0).
-endif.
-ifndef('TIMEZONE-FLAG_TIMEZOME_FLAG_LOCAL').
-define('TIMEZONE-FLAG_TIMEZOME_FLAG_LOCAL', 1).
-endif.
-ifndef('TIMEZONE-FLAG_TIMEZOME_FLAG_OFFSET').
-define('TIMEZONE-FLAG_TIMEZOME_FLAG_OFFSET', 2).
-endif.
-ifndef('TREATMENT-ACTION_TREATMENT_ACTION_DROP').
-define('TREATMENT-ACTION_TREATMENT_ACTION_DROP', 0).
-endif.
-ifndef('TREATMENT-ACTION_TREATMENT_ACTION_SHAPE').
-define('TREATMENT-ACTION_TREATMENT_ACTION_SHAPE', 1).
-endif.
-ifndef('TREATMENT-ACTION_TREATMENT_ACTION_MARK').
-define('TREATMENT-ACTION_TREATMENT_ACTION_MARK', 2).
-endif.
-ifndef('TREATMENT-ACTION_TREATMENT_ACTION_PERMIT').
-define('TREATMENT-ACTION_TREATMENT_ACTION_PERMIT', 3).
-endif.
-ifndef('QOS-SEMANTICS_QOS_SEMANTICS_DESIRED').
-define('QOS-SEMANTICS_QOS_SEMANTICS_DESIRED', 0).
-endif.
-ifndef('QOS-SEMANTICS_QOS_SEMANTICS_AVAILABLE').
-define('QOS-SEMANTICS_QOS_SEMANTICS_AVAILABLE', 1).
-endif.
-ifndef('QOS-SEMANTICS_QOS_SEMANTICS_DELIVERED').
-define('QOS-SEMANTICS_QOS_SEMANTICS_DELIVERED', 2).
-endif.
-ifndef('QOS-SEMANTICS_QOS_SEMANTICS_MINIMUM').
-define('QOS-SEMANTICS_QOS_SEMANTICS_MINIMUM', 3).
-endif.
-ifndef('QOS-SEMANTICS_QOS_SEMANTICS_AUTHORIZE').
